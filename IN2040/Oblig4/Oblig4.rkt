...
;;; Del av innlevering 3b i IN2040, høst 2020, 2021, 2022, 2023, 2024
;; 
...
(define (install-primitive! tag lambda)
    (!set primitive-procedures (append primitive-procedures (list tag lambda))))