...
(define (plus x y)
    (if (zero? y)
        x
        (add1 (plus x (sub1 y)))))
; Det jeg lagde i oppgave b er en iterativ prosess som er inne i en rekursiv prosedyre.
; Det er ingen kall som blir ventet på for å bli gjort. Derimot i oppgave c så har jeg
; laget en prosedyre som venter på kall av seg selv. Det vil ligne på noe i duren av:
; (add1 (add1 (add1 (plus x (sub1 y))))) osv.
