...
public class TestResepter {
    ...
    public static void testHentId() {
        ...
        BlaaResepter blaaResept = new BlaaResepter(1, nark, lege, 1, 1);
        sjekk("testHentId == 1", blaaResept.hentId() == 1);
    }
    ...
    public static void testBruk() {
        Narkotisk nark1 = new Narkotisk("test", 100, 2.5, 1, 7);
        Lege lege = new Lege("test");
        BlaaResepter blaaResept = new BlaaResepter(1, nark1, lege, 1, 1);
        sjekk("testBruk gir true", blaaResept.bruk() == true);
        sjekk("testBruk gir false", blaaResept.bruk() == false);

        Narkotisk nark2 = new Narkotisk("test", 100, 2.5, 1, 7);
        MilResept milResept = new MilResept(1, nark2, lege, 1);
        milResept.bruk();
        milResept.bruk();
        milResept.bruk();
    ...
    public static void testFarge() {
        ...
        MilResept milResept = new MilResept(1, nark, lege, 1);
    ...
    public static void testPrisAaBetale() {
        ...
        Narkotisk nark3 = new Narkotisk("test", 100, 2.5, 1, 7);
        PResept pResept1 = new PResept(1, nark3, lege, 1, 1);
        sjekk("testPrisAaBetale, p-resept gir 0", pResept1.prisAaBetale() == 0);
        
        Narkotisk nark4 = new Narkotisk("test", 200, 2.5, 1, 7);
        PResept pResept2 = new PResept(1, nark4, lege, 1, 1);
