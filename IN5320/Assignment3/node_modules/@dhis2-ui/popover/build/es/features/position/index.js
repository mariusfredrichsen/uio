...
Given('there is not enough space between the reference element bottom and the body bottom to fit the Popover', () => {
...
Then('the horizontal center of the popover is aligned with the horizontal center of the reference element', () => {
  compareRefAndPopoverPositions((refPos, popoverPos) => {
