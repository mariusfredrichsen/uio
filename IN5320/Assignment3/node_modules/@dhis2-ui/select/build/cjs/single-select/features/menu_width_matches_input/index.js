...
(0, _cypressCucumberPreprocessor.When)('the SingleSelect menu is open', () => {
  cy.get('[data-test="dhis2-uicore-select-menu-menuwrapper"]').should('be.visible');
});
(0, _cypressCucumberPreprocessor.Then)('the SingleSelect input is left aligned with the menu', () => {
...
(0, _cypressCucumberPreprocessor.When)('the SingleSelect input and menu have the same width', () => {
