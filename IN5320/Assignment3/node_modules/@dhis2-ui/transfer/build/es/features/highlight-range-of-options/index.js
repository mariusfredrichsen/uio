...
Given('there are at least two options following the last highlighted option', () => {
...
Then('all options between the option highlighted most recently without SHIFT and the clicked option are highlighted', () => {
  cy.get('@firstBelowInitiallyHighlighted').should('have.class', 'highlighted');
});
