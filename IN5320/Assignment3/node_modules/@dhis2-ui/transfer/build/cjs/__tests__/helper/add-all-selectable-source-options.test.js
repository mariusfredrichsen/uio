...
var _addAllSelectableSourceOptions = require("../../transfer/add-all-selectable-source-options.js");
describe('Transfer - addAllSelectableSourceOptions', () => {
  ...
  it('should add all selectable source options to the selected array', () => {
    ...
    (0, _addAllSelectableSourceOptions.addAllSelectableSourceOptions)({
      sourceOptions,
      selected,
      onChange,
