...
const getMonthlyFixedPeriodByDate = _ref => {
  ...
  const monthlyPeriods = (0, _index.generateFixedPeriodsMonthly)({
    year,
    calendar,
    periodType,
    locale
  ...
  if (isDateBeforeFirstDayOfFirstPeriod) {
    const fixedPeriodsLastYear = (0, _index.generateFixedPeriodsMonthly)({
      year: year - 1,
      calendar,
      periodType,
      locale
...
var _default = getMonthlyFixedPeriodByDate;
