...
describe('conditional', () => {
  const propType = {
    ...
    selected: conditional(props => props.multiple ? propTypes.arrayOf(propTypes.string) : propTypes.string)
  };
  ...
  describe('Valid', () => {
    let props;
    afterEach(() => {
      propTypes.checkPropTypes(propType, props, 'selected', 'TestComponent');
