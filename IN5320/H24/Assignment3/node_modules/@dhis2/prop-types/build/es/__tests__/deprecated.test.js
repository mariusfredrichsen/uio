...
describe('deprecated', () => {
  ...
  it('warns when props are invalid', () => {
    ...
    propTypes.checkPropTypes(propType, props, 'deprecatedBool', 'TestComponent');
  ...
  it('does not repeat warnings when props are re-validated', () => {
    ...
    propTypes.checkPropTypes(propType, props, 'deprecatedBool', 'TestComponent');
    propTypes.checkPropTypes(propType, props, 'deprecatedBool', 'TestComponent'); // Can't explain why the spy is called 4 times, but at least
