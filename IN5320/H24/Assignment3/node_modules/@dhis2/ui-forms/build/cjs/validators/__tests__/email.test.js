...
describe('validator: email', () => {
  ...
  describe('rejects invalid email addresses', () => {
     ...
     */
    (0, _index.testValidatorValues)(_email.email, _email.invalidEmailMessage, ['plainaddress', '#@%^%#$@#$@#.com', '@example.com', 'Joe Smith <email@example.com>', 'email.example.com', 'email@example@example.com', '.email@example.com', 'email.@example.com', 'email..email@example.com',
    /*
