...
describe('final-form named export', () => {
  ...
  it.each(Object.keys(FinalForm))('should re-export the expected type for %s', exportName => {
...
describe('react-final-form named export', () => {
  ...
  it.each(Object.keys(ReactFinalForm))('should re-export the expected type for %s', exportName => {
