 ...
 * e.g. 2023TueW1
 */
export const regexWeeklyOffsetPeriodId = new RegExp('^([0-9]{4})([A-Z][a-z]{2})W([0-9]+)$');
 ...
 * e.g. 2023NovemberQ1
 */
export const regexQuarterlyOffsetPeriodId = new RegExp('^([0-9]{4})([A-Z][a-z]+)Q([0-9])$');

/**
 * Will match any standard sixmonthly period id,
 * e.g. 2023S1
 */
export const regexSixmonthlyStandardPeriodId = new RegExp('^([0-9]{4})S([0-9])$');

/**
 * Will match any offset sixmonthly period id,
 * e.g. 2023NovemberS1
 */
export const regexSixmonthlyOffsetPeriodId = new RegExp('^([0-9]{4})([A-Z][a-z]+)S([0-9])$');
 ...
 * e.g. 2023Nov
 */
export const regexYearlyFinancialPeriodId = new RegExp('^([0-9]{4})([A-Z][a-z]{2,})$');