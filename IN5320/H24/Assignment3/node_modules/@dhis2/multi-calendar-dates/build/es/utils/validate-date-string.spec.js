...
describe('validateDateString (gregory)', () => {
  ...
  it('should return an error message for a date with mixed delimiters', () => {
    expect(validateDateString('2024/02.02').errorMessage).toBe('Date string is invalid, received "2024&#x2F;02.02"');
  });
  it('should return an error message for a date missing year digits', () => {
    expect(validateDateString('200.02.02').errorMessage).toBe('Date string is invalid, received "200.02.02"');
  });
  it('should return an error message for a date missing month digits', () => {
    expect(validateDateString('2000.2.02').errorMessage).toBe('Date string is invalid, received "2000.2.02"');
  });
  it('should return an error message for a date missing day digits', () => {
    expect(validateDateString('2000.02.2').errorMessage).toBe('Date string is invalid, received "2000.02.2"');
  });
  it('should return an error message when the value is out of range', () => {
    expect(validateDateString('2025-12-32').errorMessage).toBe('value out of range: 1 <= 32 <= 31');
  });
