...
describe('useDatePicker hook', () => {
  describe('calendar info generation', () => {
    it('should render a Gregorian calendar', () => {
      ...
      const renderedHook = renderHook(() => useDatePicker({
        onDateSelect,
        date,
        options
      }));
    ...
    it('should render an Islamic calendar in Arabic', () => {
      ...
      const renderdHook = renderHook(() => useDatePicker({
        onDateSelect,
        date,
        options
      }));
...
describe('clicking a day', () => {
  ...
  it('should call the callback with correct info for a custom (Nepali) calendar', () => {
    ...
    expect(localisationHelpers.localiseMonth(calendarDate, {
      locale: 'en-NP',
      calendar: 'nepali'
    }, {})).toEqual('Chaitra');
  });
...
describe('changing the calendar on the fly', () => {
  ...
  it('should allow changing the calendar on same component', () => {
    const Component = _ref2 => {
      ...
      return /*#__PURE__*/React.createElement("div", null, result.currMonth.label);
    };
    const {
      getByText,
      rerender
    ...
    rerender( /*#__PURE__*/React.createElement(Component, {
      calendar: "ethiopic"
    }));
