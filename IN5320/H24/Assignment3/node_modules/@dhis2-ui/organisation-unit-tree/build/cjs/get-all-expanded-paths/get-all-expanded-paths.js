...
exports.getAllExpandedPaths = void 0;
/**
 * @template T
 * @param {Array.<T>} arr
 * @returns {Array.<T>}
 ...
 * @returns {string[]}
 */
const getAllExpandedPaths = initiallyExpanded => initiallyExpanded.reduce((all, curPath) => {
  const allPathsInCurPath = extractAllPathsFromPath(curPath);
  return [...all, ...allPathsInCurPath];
}, []);
exports.getAllExpandedPaths = getAllExpandedPaths;