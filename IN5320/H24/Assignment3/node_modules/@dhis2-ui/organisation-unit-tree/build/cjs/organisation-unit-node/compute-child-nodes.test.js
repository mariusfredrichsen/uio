...
describe('computeChildNodes', () => {
  ...
  const pathsToIncludeWithMatchingAncestors = ['foo/bar/foobar/barbaz', 'foo/bar/barbaz/bazbazfoo'];
  ...
  it('should return all children when filter is empty', () => {
    ...
    const filter = [];
    const actual = (0, _computeChildNodes.computeChildNodes)(node, filter);
