...
Given('a filter containing the first child of the first second level is provided', () => {});
Given('the second level nodes each have a child node', () => {});
Given('a filter containing the first child of the second level is provided', () => {});
Given('a filter containing the second child of the first level is provided', () => {});
...
Then('the first child node of the first node on the second level is visible', () => {
