...
import { userNoAccess, userViewAccess, userViewEditAccess, groupNoAccess, groupViewAccess, groupViewEditAccess } from '../fixtures/index.js';
...
Given('a sharing dialog with user item with view and edit is visible', () => {
  ...
  cy.visitStory('sharing-dialog', 'visualization');
  cy.contains('Sharing and access').should('be.visible');
  cy.contains('.details-text', 'A user').should('be.visible').contains('Can view and edit').should('be.visible').closest('.wrapper').as('user-list-item');
});
...
Given('a sharing dialog with group item with view and edit is visible', () => {
  ...
  cy.visitStory('sharing-dialog', 'visualization');
  cy.contains('Sharing and access').should('be.visible');
  cy.contains('.details-text', 'A group').should('be.visible').contains('Can view and edit').should('be.visible').closest('.wrapper').as('group-list-item');
});
