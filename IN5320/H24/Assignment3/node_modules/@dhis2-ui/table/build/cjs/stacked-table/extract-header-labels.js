...
var _stackedTableHead = require("./stacked-table-head.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
const isChildTableHead = child => child.type === _stackedTableHead.StackedTableHead;
const extractChildrenProp = component => component.props.children;
const extractRowsFromTableChildren = children => _react.default.Children.toArray(children).filter(isChildTableHead)
