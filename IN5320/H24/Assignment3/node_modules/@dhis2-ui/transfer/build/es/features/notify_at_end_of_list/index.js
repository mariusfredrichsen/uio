...
Given('the Transfer has enough items to fill the picked list completely', () => {
  cy.visitStory('Transfer End Of List', 'Full Picked List');
  cy.wrap('picked').as('listType');
});
Given('the Transfer does not have enough items to fill the source list completely', () => {
