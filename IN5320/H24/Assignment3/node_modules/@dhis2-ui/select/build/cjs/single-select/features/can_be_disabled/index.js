...
(0, _cypressCucumberPreprocessor.Given)('a disabled SingleSelect with options and a selection is rendered', () => {
  cy.visitStory('SingleSelect', 'With options, a selection and disabled');
});
(0, _cypressCucumberPreprocessor.Given)('the SingleSelect is closed', () => {
  cy.contains('option one').should('not.exist');
  cy.contains('option two').should('not.exist');
  cy.contains('option three').should('not.exist');
});
(0, _cypressCucumberPreprocessor.Given)('the SingleSelect is focused', () => {
