...
class TestInMemoryInvertedIndexWithCompression(unittest.TestCase):
    ...
    def test_access_postings_with_normalization(self):
        self._tester.test_access_postings_with_normalization()
    ...
    def test_memory_usage(self):
        ...
        index_uncompressed = in3120.InMemoryInvertedIndex(corpus, ["body"], self._tester._analyzer, False)
        self.assertIsNotNone(index_uncompressed)
        snapshot_uncompressed = tracemalloc.take_snapshot()
        index_compressed = in3120.InMemoryInvertedIndex(corpus, ["body"], self._tester._analyzer, True)
