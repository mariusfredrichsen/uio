...
class TestBooleanSearchEngine(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._index = in3120.InMemoryInvertedIndex(self._corpus, ["body"], analyzer)
    ...
    def test_no_options_specified(self):
        self._verify_matches("AND('tyler', saunders)", [1291], None)
    ...
    def test_optimization(self):
        for expression in ("AND('Ms. Shannon Rubio')", 'AND(OR("Ms. Malik"), OR("Shannon Malik"), OR("Rubio Malik"))'):
            ...
            for optimize in (True, False):
                ...
                _ = list(engine.evaluate(expression, options))
