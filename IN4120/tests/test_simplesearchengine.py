...
class TestSimpleSearchEngine(unittest.TestCase):
    ...
    def test_mesh_corpus(self):
        ...
        index = in3120.InMemoryInvertedIndex(corpus, ["body"], self._analyzer)
        engine = in3120.SimpleSearchEngine(corpus, index)
        query = "polluTION Water"
        self._process_two_term_query_verify_matches(query, engine, in3120.SimpleSearchEngine.Options(match_threshold=0.1, hit_count=10),
                                                    (10, [25274, 25275, 25276]))
        self._process_two_term_query_verify_matches(query, engine, in3120.SimpleSearchEngine.Options(match_threshold=1.0, hit_count=10),
                                                    (3, [25274, 25275, 25276]))
    ...
    def test_canonicalized_corpus(self):
        ...
        self._process_query_verify_matches("ﾘﾝｸ", engine,  # Should match "リンク".
                                           in3120.SimpleSearchEngine.Options(match_threshold=1.0, hit_count=10),
                                           (1, 1.0, [0]))
    ...
    def test_synthetic_corpus(self):
        ...
        self._process_query_verify_matches("baj BAJ    baj", engine,
                                           in3120.SimpleSearchEngine.Options(match_threshold=1.0, hit_count=27),
                                           (27, 9.0, [0]))
        self._process_query_verify_matches("baj caj", engine,
                                           in3120.SimpleSearchEngine.Options(match_threshold=1.0, hit_count=100),
                                           (27, None, None))
        self._process_query_verify_matches("baj caj daj", engine,
                                           in3120.SimpleSearchEngine.Options(match_threshold=2/3 + epsilon, hit_count=100),
                                           (79, None, None))
        self._process_query_verify_matches("baj caj", engine,
                                           in3120.SimpleSearchEngine.Options(match_threshold=2/3 + epsilon, hit_count=100),
        ...
        self._process_query_verify_matches("baj cek dil", engine,
                                           ...
                                           (1, None, None))
        self._process_query_verify_matches("baj cek dil", engine,
                                           in3120.SimpleSearchEngine.Options(match_threshold=2/3 + epsilon, hit_count=80),
    ...
    def test_document_at_a_time_traversal_mesh_corpus(self):
        ...
        inner = in3120.InMemoryInvertedIndex(corpus1, ["body"], self._analyzer)
        ...
        if test2 and not test1:
            warnings.warn("Unorthodox traversal ordering detected. This may or may not be benign.")
