...
class ExpressionComposerDecorator(MutableMapping):
    ...
    def __init__(self, grammar: Dict[str, Any]):
        ...
        self._mapping: Dict[str, str] = {}  # The backing store for the mapping itself.
        self._counts: Dict[str, int] = {}   # For each key in the mapping, keep track of many times it has been accessed.
